      ...
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          <Link
            ...
            target="_blank"
            className="w-8 h-8 rounded-full flex justify-center items-center border border-transparent text-primary hover:shadow-md hover:shadow-blue-100/25 hover:border-white hover:bg-slate-200 hover:text-blue-900 transition duration-300 ease-in-out"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
